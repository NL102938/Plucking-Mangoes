...
function setup() {
	...
	dground=new Ground();
	stones=new Stone(100,460,23,23);
  stones.scale=0.5;
	mango1=new Mango(600,290,34,34);
  mango1.scale=0.5;
	mango2=new Mango(855,325,35,35);
  mango2.scale=0.5;
	mango3=new Mango(670,260,35,35);
  mango3.scale=0.5;
	mango4=new Mango(730,200,35,35);
  mango4.scale=0.5;
	mango5=new Mango(710,320,36,36);
  mango5.scale=0.5;
	mango6=new Mango(780,250,35,35);
  mango6.scale=0.5;
	mango7=new Mango(825,170,33,33);
  mango7.scale=0.5;
	mango8=new Mango(880,260,35,35);
  mango8.scale=0.5;
	mango9=new Mango(940,220,35,35);
  mango9.scale=0.5;
	mango10=new Mango(980,305,35,35);
  mango10.scale=0.5;
